...
class UserMovieRating extends Component {
  ...
  reviewRateMovie = () => {
    this.rateMovie();
    if (this.state.review !== "") this.reviewMovie();
  };
      ...
      <>
        ...
        <div className="card border-secondary bg-dark my-1">
          <div className="card-body">
            <p>
              <strong>{this.props.auth.user.first_name}</strong>
            </p>
            ...
            >
              <p>{this.props.currentUserReview.review}</p>
            </StatusBasedComponent>
          </div>
        </div>
      </>
      ...
      <div className="p-2 bg-dark ">
        ...
        <div className="w-100">
          ...
          <div className="form-group">
            <textarea className="w-100" onChange={this.setReview}></textarea>
          </div>
          <div className="form-group">
            <button className="btn btn-primary" onClick={this.reviewRateMovie}>
              Submit
            </button>
          </div>
        </div>
