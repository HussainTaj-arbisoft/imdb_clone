  ...
  _renderUpNextSwiper() {
    ...
    return (
      <Swiper
        ...
        spaceBetween={5}
        slidesPerView={"auto"}
        id="peekVideoCarouselNextSidebar"
        ...
        {upNextSwiperMovies.map((movie) => {
          ...
          return (
            <SwiperSlide key={movie.id}>
              <Link
                to={`/movie/${movie.id}`}
                className="d-flex p-2 align-items-center text-decoration-none"
              >
                ...
                <div className="d-flex align-items-end swiper-slide-caption">
                  ...
                  <div className="px-4 w-100 d-flex align-items-center">
                    ...
                    <div>
                      <h1>
                        {movie.title}
                        <small className="text-secondary pl-2">
                          {duration}
                        </small>
                      </h1>
                      <p>{movie.tagline}</p>
    ...
    if (!movies || movies.length === 0)
      ...
      content = (
        <div className="row pt-4 text-light text-left">
          <div className="col-lg-8 col-md-12">{peekVideoSwiper}</div>
