      ...
      <div className="container py-4 text-light">
        <div className="row bg-dark rounded">
          <div className="col-lg-8 col-md-12 p-0">
            <Swiper slidesPerView={1} navigation lazy>
          ...
          <div className="col-lg-4 col-md-12 bg-dark">
            <div className="d-flex m-2">
              <img src={movie.poster_image} alt="poster" width="100" />
              <div className="p-2">
        ...
        <div className="my-4" style={{ maxHeight: "50vh", overflow: "auto" }}>
          <table className="table rounded table-dark bg-dark table-borderless table-striped table-sm">
            <thead>
              <tr>
                <th scope="col"></th>
