...
export const listPeekMovies = () => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(types.MOVIE_PEEK_LIST_RESPONSE, response)
      );
    });
};
...
export const detailMovie = (movie_id) => (dispatch) => {
  ...
  Promise.all([axios.get(detailMovieUrl), axios.get(detailMovieCrewUrl)])
    .then(([responseMovie, responseCrew]) => {
      dispatch({
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(types.MOVIE_DETAIL_RESPONSE, response)
      );
    });
};
...
export const rateMovie = (movie_id, user_id, rating) => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(
          types.MOVIE_USER_RATING_RATE_RESPONSE,
          response
        )
      );
    });
...
export const getUserMovieRating = (movie_id) => (dispatch) => {
  ...
  axios
    ...
    .catch((response) => {
      dispatch(
        createErrorResponseAction(
          types.MOVIE_USER_RATING_RETRIEVE_RESPONSE,
          response
        )
      );
    });
...
export const getUserMovieReview = (movie_id) => (dispatch) => {
  ...
  axios
    ...
    .catch((response) => {
      dispatch(
        createErrorResponseAction(
          types.MOVIE_USER_REVIEW_RETRIEVE_RESPONSE,
          response
        )
      );
    });
...
export const reviewMovie = (movie_id, user_id, review) => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(types.MOVIE_USER_REVIEW_RESPONSE, response)
      );
    });
};
...
export const searchMovie = (searchString) => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(types.MOVIE_SEARCH_RESPONSE, response)
      );
    });
};
...
export const listFanFavoriteMovies = () => (dispatch) => {
  ...
  axios
    .get(MOVIE_FAN_FAVORITE_LIST_URL)
    .then((response) => {
      dispatch({
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(
          types.MOVIE_FAN_FAVORITE_LIST_RESPONSE,
          response
        )
      );
    });
...
export const listRecommendedMovies = () => (dispatch) => {
  ...
  axios
    .get(MOVIE_RECOMMENDATION_LIST_URL)
    .then((response) => {
      dispatch({
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(
          types.MOVIE_RECOMMENDTION_LIST_RESPONSE,
          response
        )
      );
    });
...
export const listOwnedMovies = () => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(types.MOVIE_OWNED_LIST_RESPONSE, response)
      );
    });
};
