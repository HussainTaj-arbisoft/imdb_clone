...
export const listUsers = () => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(types.CHAT_USER_LIST_RESPONSE, response)
      );
    });
};
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(
          types.CHAT_USER_CONTACT_MESSAGES_RESPONSE,
          response
        )
      );
    });
...
export const listUserContacts = () => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(
          types.CHAT_USER_CONTACTS_LIST_RESPONSE,
          response
        )
      );
    });
...
export const updateLastSeen = () => (dispatch) => {
  ...
  axios
    ...
    .catch(({ response }) => {
      dispatch(
        createErrorResponseAction(
          types.CHAT_UPDATE_LAST_SEEN_RESPONSE,
          response
        )
      );
    });
